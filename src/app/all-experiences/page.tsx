...
import TableExperiences from '@/components/table/tableExperience';
        ...
        <section className="flex min-h-screen flex-col items-center px-6 py-10 lg:p-24">
            <div className="z-2 w-full max-w-7xl font-mono text-sm">
                <div>
                    ...
                    <h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">All Experiences</h1>
                    <TableExperiences />
                </div>
            </div>
        </section>
